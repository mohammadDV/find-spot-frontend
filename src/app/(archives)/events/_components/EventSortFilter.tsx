...
const sortOptions = [
    { label: "newest", value: "newest", sort: "desc", column: "created_at" },
    { label: "oldest", value: "oldest", sort: "asc", column: "created_at" },
    { label: "priceHighest", value: "price_high", sort: "desc", column: "amount" },
    { label: "priceLowest", value: "price_low", sort: "asc", column: "amount" }
];

export const EventSortFilter = () => {
            ...
            <SelectContent>
                {sortOptions.map((option) => (
                    <SelectItem key={option.value} value={option.value}>
                        {t(`events.${option.label}`) || option.label}
                    </SelectItem>
                ))}
            </SelectContent>
        </Select>
